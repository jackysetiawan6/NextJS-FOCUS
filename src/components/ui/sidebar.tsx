      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            side={side}
          >
            {/* Visually hidden title for accessibility, per Radix UI recommendation */}
...
>(({ className, ...props }, ref) => {
  return (
    <main
      ref={ref}
      className={cn(
        "relative flex min-h-svh flex-1 flex-col bg-background min-w-0", // Added min-w-0
...
>(({ size = "md", isActive, className, children, ...props }, ref) => {
  ...
  return (
    <div // Changed from <Comp> or <a> to <div>
      ...
      {...props} // Other props like onClick (if any), onMouseEnter, etc.
    >
      {children}
    </div>
  );
