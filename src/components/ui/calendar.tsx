...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn("p-0", className)} // Removed p-3, parent CardContent handles padding
      classNames={{
        ...
        cell: cn(
          "h-9 flex-1 text-center text-sm p-0 relative focus-within:relative focus-within:z-20",
